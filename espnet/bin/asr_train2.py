...
if __name__ == "__main__":
    ...
    args = [
        #"--config","/espnet/egs/aishell/asr1/conf/train_longformer.yaml",
        "--config","/espnet/egs/aishell/asr1/conf/conformer_change.yaml",
        "--preprocess-conf","/espnet/egs/aishell/asr1/conf/specaug.yaml",
        "--backend","pytorch",
        "--ngpu","1",
        "--outdir","/data0/lzh/debug_file",
        "--tensorboard-dir","/espnet/egs/aishell/asr1/tensorboard",
        "--debugmode","1",
        "--dict","/espnet/egs/aishell/asr1/data/lang_1char/train_sp_units.txt",
        "--debugdir","exp/train_sp_pytorch",
        "--minibatches","0",
        "--verbose","1",
        "--resume","",
        "--train-json","/espnet/egs/aishell/asr1/dump/train_sp/deltafalse/data.json",
        "--valid-json","/espnet/egs/aishell/asr1/dump/dev/deltafalse/data.json",
        ] 
